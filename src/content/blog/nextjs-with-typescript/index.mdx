...
import ss3 from "./screenshot-03.png";
...
<Image src={ss1} alt="Vs Code Screenshot 01" densities={[0.5, 1]} />
...
<Image src={ss2} alt="Vs Code Screenshot 02" densities={[0.5, 1]} />
...
<Image src={ss3} alt="Vs Code Screenshot 03" densities={[0.5, 1]} />
